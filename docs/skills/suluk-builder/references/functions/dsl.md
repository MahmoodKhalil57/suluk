...
```ts
isBind(v: unknown): v is BindRef
```
**Parameters:**
- `v: unknown`
**Returns:** `v is BindRef`
...
frontend + backend files into one installable unit. CANDIDATE tooling — NOT official OAS.
```ts
isEach(c: unknown): c is EachRef
```
**Parameters:**
- `c: unknown`
**Returns:** `c is EachRef`
...
frontend + backend files into one installable unit. CANDIDATE tooling — NOT official OAS.
```ts
isSlot(c: unknown): c is SlotRef
```
**Parameters:**
- `c: unknown`
**Returns:** `c is SlotRef`
...
frontend + backend files into one installable unit. CANDIDATE tooling — NOT official OAS.
```ts
isListSpec(s: ParamSpec): s is { type: "list"; options: string[]; controls: ListControl[]; default?: string[] }
```
**Parameters:**
- `s: ParamSpec`
**Returns:** `s is { type: "list"; options: string[]; controls: ListControl[]; default?: string[] }`

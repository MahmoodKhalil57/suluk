...
It pairs with [`@suluk/keys`](../keys) (the delegation-chain algebra joins this ledger for pooled
subtree headroom) and [`@suluk/billing`](../billing) (whose webhook dispatch composes `grantOnce`

...
The shared, **zero-dependency** leaf both [`@suluk/journeys`](../journeys) (BDD outlines + a runnable
suite) and [`@suluk/sdk`](../sdk) (typed-client metadata + sampling) read (C040-P2). It imports
...
[`@suluk/journeys`](../journeys) and [`@suluk/sdk`](../sdk).

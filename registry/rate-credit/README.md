...
- [`@suluk/core`](../../tooling/ts/packages/core) — `toProblemDetails`, the shared RFC-9457 envelope (see below)
...
This is the HYBRID pattern (ADR [C050](../../doc/architecture/decisions/C050-registry-distributed-framework.md)/[C052](../../doc/architecture/decisions/C052-npm-vs-registry-boundary.md)): you **own** the policy, and **npm** the shared correctness surface.

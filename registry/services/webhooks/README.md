...
`registryDependencies` pull in the base [`app`](../app) module automatically (the shared Hono app + the
...
- **registry (`registryDependencies`):** [`MahmoodKhalil57/suluk/app`](../app) — the base Hono app + the

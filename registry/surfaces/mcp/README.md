...
- [`@suluk/mcp`](../../tooling/ts/packages/mcp) — the MCP protocol + per-caller tool projection (see below)
...
This is the HYBRID pattern (ADR [C050](../../doc/architecture/decisions/C050-registry-distributed-framework.md)/[C052](../../doc/architecture/decisions/C052-npm-vs-registry-boundary.md)): you **own** the seam, and **npm** the protocol + the OAuth server.

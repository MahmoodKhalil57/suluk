...
[Suluk](../../packages.md) / @suluk/deploy
...
- [DeployFile](interfaces/DeployFile.md)
- [DeployInput](interfaces/DeployInput.md)
- [DeployPlan](interfaces/DeployPlan.md)
- [DeployProvider](interfaces/DeployProvider.md)
- [DeployStep](interfaces/DeployStep.md)
- [DurableBinding](interfaces/DurableBinding.md)
...
- [StoredObject](interfaces/StoredObject.md)

## Variables

- [cloudflare](variables/cloudflare.md)
- [DEFAULT\_COMPAT\_DATE](variables/DEFAULT_COMPAT_DATE.md)
- [providers](variables/providers.md)

## Functions

- [columnDdl](functions/columnDdl.md)
- [createTable](functions/createTable.md)
- [durableBindings](functions/durableBindings.md)
- [entityColumns](functions/entityColumns.md)
- [memoryStorage](functions/memoryStorage.md)
- [migrationSql](functions/migrationSql.md)
- [r2Storage](functions/r2Storage.md)
- [schemaToSql](functions/schemaToSql.md)
- [secretPushPlan](functions/secretPushPlan.md)

...
[Suluk](../../packages.md) / @suluk/scalar
...
- [ScalarOptions](interfaces/ScalarOptions.md)
- [ScalarV4Options](interfaces/ScalarV4Options.md)

## Variables

- [SCALAR\_VERSION](variables/SCALAR_VERSION.md)
- [SULUK\_FORK\_CDN](variables/SULUK_FORK_CDN.md)
- [SULUK\_FORK\_STANDALONE\_VERSION](variables/SULUK_FORK_STANDALONE_VERSION.md)

## Functions

- [enrichedSpec](functions/enrichedSpec.md)
- [enrichedV4](functions/enrichedV4.md)
- [enrichFacetBadges](functions/enrichFacetBadges.md)
- [enrichFacetDetail](functions/enrichFacetDetail.md)
- [enrichV4Facets](functions/enrichV4Facets.md)
- [scalarHtml](functions/scalarHtml.md)
- [scalarResponse](functions/scalarResponse.md)
- [scalarV4Html](functions/scalarV4Html.md)
- [scalarV4Response](functions/scalarV4Response.md)
- [v4Intro](functions/v4Intro.md)

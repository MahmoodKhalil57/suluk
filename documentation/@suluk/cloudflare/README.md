...
[Suluk](../../packages.md) / @suluk/cloudflare
...
- **`kvRateLimitStore`** — the production, KV-backed `RateLimitStore` for [`@suluk/hono`](../hono/README.md)'s `enforceRateLimit` (a fixed-window counter that fails *open* on a KV blip). Structurally typed, so it plugs straight in with no `@suluk/hono` dependency.
...
- **vs [`@suluk/deploy`](../deploy/README.md)** — `@suluk/deploy` is *pure planning* behind a swappable provider interface; it computes the files + ordered steps to ship but never executes anything or touches credentials. `@suluk/cloudflare` is the concrete Cloudflare *doer*. Use `@suluk/deploy` when you want a provider-agnostic plan; use this when you're committing to Cloudflare and want it to run.
...
- [CloudflareError](classes/CloudflareError.md)
...
- [ConsumeResult](interfaces/ConsumeResult.md)
- [D1Database](interfaces/D1Database.md)
- [DeployPlan](interfaces/DeployPlan.md)
- [DeployResult](interfaces/DeployResult.md)
- [DeployWorkerOptions](interfaces/DeployWorkerOptions.md)
- [DurableObjectBinding](interfaces/DurableObjectBinding.md)
- [KvLike](interfaces/KvLike.md)
...
- [UploadSession](interfaces/UploadSession.md)
- [WorkerBinding](interfaces/WorkerBinding.md)
- [WorkerMigration](interfaces/WorkerMigration.md)
...
- [applyMigrations](functions/applyMigrations.md)
- [assetHash](functions/assetHash.md)
- [d1Rows](functions/d1Rows.md)
- [deploy](functions/deploy.md)
- [deployWith](functions/deployWith.md)
- [deployWorker](functions/deployWorker.md)
- [ensureWwwRedirect](functions/ensureWwwRedirect.md)
- [extractAssetRuleFiles](functions/extractAssetRuleFiles.md)
- [kvDelete](functions/kvDelete.md)
- [kvGet](functions/kvGet.md)
- [kvList](functions/kvList.md)
- [kvPut](functions/kvPut.md)
- [kvRateLimitStore](functions/kvRateLimitStore.md)
- [memoryRateLimitStore](functions/memoryRateLimitStore.md)
- [provisionD1](functions/provisionD1.md)
- [provisionKvNamespace](functions/provisionKvNamespace.md)
- [provisionR2Bucket](functions/provisionR2Bucket.md)
- [putCronTriggers](functions/putCronTriggers.md)
- [putSecret](functions/putSecret.md)
- [putSecrets](functions/putSecrets.md)
- [queryD1](functions/queryD1.md)
- [removeWwwRedirect](functions/removeWwwRedirect.md)
- [resolveZoneId](functions/resolveZoneId.md)
- [uploadAssets](functions/uploadAssets.md)

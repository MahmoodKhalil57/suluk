...
[Suluk](../../packages.md) / @suluk/stubgen
...
- **The contract half is generic.** `renderContract` emits a [`@suluk/hono`](../hono/README.md) `RouteContract`
...
the `HandlerTarget` seam. It's the gap-filling step of the [`@suluk/journeys`](../journeys/README.md) arc and
emits contracts for [`@suluk/hono`](../hono/README.md).
...
- [GeneratedStub](interfaces/GeneratedStub.md)
- [HandlerTarget](interfaces/HandlerTarget.md)
- [StubField](interfaces/StubField.md)
- [StubGap](interfaces/StubGap.md)
- [StubSpec](interfaces/StubSpec.md)

## Variables

- [honoEffectTarget](variables/honoEffectTarget.md)
- [honoTarget](variables/honoTarget.md)

## Functions

- [generateStub](functions/generateStub.md)
- [generateStubs](functions/generateStubs.md)
- [renderContract](functions/renderContract.md)
- [stubSpec](functions/stubSpec.md)

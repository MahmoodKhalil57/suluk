...
- [AudienceContact](interfaces/AudienceContact.md)
- [AudienceProvider](interfaces/AudienceProvider.md)
- [AudienceResult](interfaces/AudienceResult.md)
- [BrandedEmailOptions](interfaces/BrandedEmailOptions.md)
- [ConsoleAudienceOptions](interfaces/ConsoleAudienceOptions.md)
- [ConsoleProviderOptions](interfaces/ConsoleProviderOptions.md)
- [EmailBrand](interfaces/EmailBrand.md)
...
- [ResendAudienceOptions](interfaces/ResendAudienceOptions.md)
- [ResendProviderOptions](interfaces/ResendProviderOptions.md)
- [SendResult](interfaces/SendResult.md)
- [StoredEmail](interfaces/StoredEmail.md)
- [SyncResult](interfaces/SyncResult.md)
- [TemplateContext](interfaces/TemplateContext.md)

## Variables

- [DEFAULT\_EMAIL\_STRINGS](variables/DEFAULT_EMAIL_STRINGS.md)
- [TEMPLATE\_STRINGS](variables/TEMPLATE_STRINGS.md)

## Functions

- [changeEmailEmail](functions/changeEmailEmail.md)
- [consoleAudience](functions/consoleAudience.md)
- [consoleProvider](functions/consoleProvider.md)
- [deleteAccountEmail](functions/deleteAccountEmail.md)
- [newsletterEmail](functions/newsletterEmail.md)
- [orderConfirmationEmail](functions/orderConfirmationEmail.md)
- [orderStatusEmail](functions/orderStatusEmail.md)
- [pickProvider](functions/pickProvider.md)
- [renderEmailHtml](functions/renderEmailHtml.md)
- [resendAudience](functions/resendAudience.md)
- [resendProvider](functions/resendProvider.md)
- [resetPasswordEmail](functions/resetPasswordEmail.md)
- [storeProvider](functions/storeProvider.md)
- [syncNewsletter](functions/syncNewsletter.md)
- [verifyEmail](functions/verifyEmail.md)

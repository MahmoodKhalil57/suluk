...
[Suluk](../../../packages.md) / [@suluk/harden](../README.md) / DocAudit

# Interface: DocAudit

Defined in: [audit.ts:20](https://github.com/MahmoodKhalil57/suluk/blob/84f6cb98bf3145a19eb32e3dedc636cf3a1a9d0b/tooling/ts/packages/harden/src/audit.ts#L20)
...
> **bySeverity**: `Record`\<[`Severity`](../type-aliases/Severity.md), `number`\>
...
Defined in: [audit.ts:18](https://github.com/MahmoodKhalil57/suluk/blob/84f6cb98bf3145a19eb32e3dedc636cf3a1a9d0b/tooling/ts/packages/harden/src/audit.ts#L18)

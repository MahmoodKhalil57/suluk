...
[Suluk](../../packages.md) / @suluk/harden
...
([`@suluk/agents`](../agents/README.md)' `gradeAgent`). `combineGrades` folds them into one contract grade — on the **letter**,
...
- [assertCombinedGrade](functions/assertCombinedGrade.md)
- [assertGrade](functions/assertGrade.md)
- [auditDocument](functions/auditDocument.md)
- [auditOperation](functions/auditOperation.md)
- [auditReadiness](functions/auditReadiness.md)
- [combineGrades](functions/combineGrades.md)
- [grade](functions/grade.md)
- [hardenDocument](functions/hardenDocument.md)
- [hardenSchema](functions/hardenSchema.md)

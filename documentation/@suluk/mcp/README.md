...
- [McpOptions](interfaces/McpOptions.md)
- [McpTool](interfaces/McpTool.md)
- [RpcContext](interfaces/RpcContext.md)
- [RpcRequest](interfaces/RpcRequest.md)
- [RpcResponse](interfaces/RpcResponse.md)
- [ToolsOptions](interfaces/ToolsOptions.md)

## Type Aliases

- [ToolExec](type-aliases/ToolExec.md)

## Variables

- [DISCOVER\_TOOL](variables/DISCOVER_TOOL.md)
- [LATEST\_PROTOCOL](variables/LATEST_PROTOCOL.md)
- [SUPPORTED\_PROTOCOLS](variables/SUPPORTED_PROTOCOLS.md)

## Functions

- [appExec](functions/appExec.md)
- [buildRequest](functions/buildRequest.md)
- [handleRpc](functions/handleRpc.md)
- [mcpApp](functions/mcpApp.md)
- [originExec](functions/originExec.md)
- [toolsFrom](functions/toolsFrom.md)

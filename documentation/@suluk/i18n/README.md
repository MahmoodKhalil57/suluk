...
- [LocaleDef](interfaces/LocaleDef.md)

## Type Aliases

- [Catalog](type-aliases/Catalog.md)
- [Direction](type-aliases/Direction.md)
- [KeyParity](type-aliases/KeyParity.md)
- [LocaleCode](type-aliases/LocaleCode.md)
- [NamespaceLoaders](type-aliases/NamespaceLoaders.md)

## Functions

- [defineLocales](functions/defineLocales.md)
- [dirOf](functions/dirOf.md)
- [formatCurrency](functions/formatCurrency.md)
- [formatDate](functions/formatDate.md)
- [formatNumber](functions/formatNumber.md)
- [gradeCompleteness](functions/gradeCompleteness.md)
- [isSupportedLocale](functions/isSupportedLocale.md)
- [loadMessages](functions/loadMessages.md)
- [localeCodes](functions/localeCodes.md)
- [localeFromCookie](functions/localeFromCookie.md)
- [localeFromRequest](functions/localeFromRequest.md)
- [negotiateLocale](functions/negotiateLocale.md)
- [readCookie](functions/readCookie.md)
- [resolveLocale](functions/resolveLocale.md)
- [t](functions/t.md)
- [translator](functions/translator.md)

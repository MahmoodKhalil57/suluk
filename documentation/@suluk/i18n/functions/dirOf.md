...
[Suluk](../../../packages.md) / [@suluk/i18n](../README.md) / dirOf

# Function: dirOf()

> **dirOf**(`config`, `code`): [`Direction`](../type-aliases/Direction.md)

Defined in: [locale.ts:51](https://github.com/MahmoodKhalil57/suluk/blob/aaf30cfa393544c0ef54e004d9e2f37412540fa8/tooling/ts/packages/i18n/src/locale.ts#L51)

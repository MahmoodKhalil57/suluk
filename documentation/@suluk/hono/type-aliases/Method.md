...
[Suluk](../../../packages.md) / [@suluk/hono](../README.md) / Method

# Type Alias: Method

> **Method** = `"get"` \| `"post"` \| `"put"` \| `"patch"` \| `"delete"` \| `"head"` \| `"options"`

Defined in: [tooling/ts/packages/hono/src/contract.ts:9](https://github.com/MahmoodKhalil57/suluk/blob/84f6cb98bf3145a19eb32e3dedc636cf3a1a9d0b/tooling/ts/packages/hono/src/contract.ts#L9)

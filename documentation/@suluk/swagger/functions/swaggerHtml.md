...
[Suluk](../../../packages.md) / [@suluk/swagger](../README.md) / swaggerHtml

# Function: swaggerHtml()

> **swaggerHtml**(`doc`, `opts?`): [`RenderResult`](../interfaces/RenderResult.md)

Defined in: [index.ts:38](https://github.com/MahmoodKhalil57/suluk/blob/0d44883ee3fb031bfb991981eb925e438e45c79f/tooling/ts/packages/swagger/src/index.ts#L38)

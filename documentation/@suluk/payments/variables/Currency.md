...
[Suluk](../../../packages.md) / [@suluk/payments](../README.md) / Currency

# Variable: Currency

> `const` **Currency**: `object`

Defined in: [tooling/ts/packages/payments/src/types.ts:13](https://github.com/MahmoodKhalil57/suluk/blob/6ca20cc58a630d10d850c784bcf2e00a0e69bc7c/tooling/ts/packages/payments/src/types.ts#L13)

...
[Suluk](../../../packages.md) / [@suluk/provision](../README.md) / envSink

# Function: envSink()

> **envSink**(`opts?`): [`BindingSink`](../interfaces/BindingSink.md)

Defined in: [provision/src/env-sink.ts:19](https://github.com/MahmoodKhalil57/suluk/blob/686a9e1a5deb9fd975e16addda8eab9635242992/tooling/ts/packages/provision/src/env-sink.ts#L19)

...
[Suluk](../../packages.md) / @suluk/agents
...
The returned `durableObjects` is exactly the shape [`@suluk/deploy`](../deploy/README.md)'s `DeployInput.durableObjects` /
[`@suluk/cloudflare`](../cloudflare/README.md)'s `DeployPlan.durableObjects` expect — so the same contract that scaffolds the
...
The grade is the agent-COMPOSITION dimension; tool-INPUT hardening stays [`@suluk/harden`](../harden/README.md)'s job (an
...
### Pyramid — the determinism gradient as layers ([C035](../../_media/C035-cloudflare-terminology-alignment.md))
...
- [AgentContextLoad](interfaces/AgentContextLoad.md)
- [AgentDiagramOptions](interfaces/AgentDiagramOptions.md)
- [AgentGradeFinding](interfaces/AgentGradeFinding.md)
- [AgentGradeOptions](interfaces/AgentGradeOptions.md)
- [AgentGradeReport](interfaces/AgentGradeReport.md)
- [AgentLayer](interfaces/AgentLayer.md)
- [AgentManifest](interfaces/AgentManifest.md)
- [AgentManifestGoverned](interfaces/AgentManifestGoverned.md)
- [AgentManifestNode](interfaces/AgentManifestNode.md)
- [AgentManifestRoute](interfaces/AgentManifestRoute.md)
- [AgentManifestSkill](interfaces/AgentManifestSkill.md)
- [AgentRuntimeArtifacts](interfaces/AgentRuntimeArtifacts.md)
- [AgentRuntimeProvider](interfaces/AgentRuntimeProvider.md)
- [CatalogEntry](interfaces/CatalogEntry.md)
- [ClaudePluginArtifacts](interfaces/ClaudePluginArtifacts.md)
- [ClaudePluginOptions](interfaces/ClaudePluginOptions.md)
...
- [ContextReport](interfaces/ContextReport.md)
- [DiagramNode](interfaces/DiagramNode.md)
- [EffectiveAgent](interfaces/EffectiveAgent.md)
- [EffectiveSkill](interfaces/EffectiveSkill.md)
- [FlattenSuggestion](interfaces/FlattenSuggestion.md)
...
- [ModelFit](interfaces/ModelFit.md)
- [NodeAgentArtifacts](interfaces/NodeAgentArtifacts.md)
- [NodeAgentOptions](interfaces/NodeAgentOptions.md)
- [OpenRouterAgentManifest](interfaces/OpenRouterAgentManifest.md)
- [OpenRouterFunctionTool](interfaces/OpenRouterFunctionTool.md)
- [OpenRouterOptions](interfaces/OpenRouterOptions.md)
- [PaidToolPrice](interfaces/PaidToolPrice.md)
- [PatternAffordance](interfaces/PatternAffordance.md)
- [PolicyConstrainResult](interfaces/PolicyConstrainResult.md)
- [PolicyNarrowing](interfaces/PolicyNarrowing.md)
- [Preferences](interfaces/Preferences.md)
- [ResolvedOperation](interfaces/ResolvedOperation.md)
...
- [ToolContextCost](interfaces/ToolContextCost.md)
- [UnflattenSuggestion](interfaces/UnflattenSuggestion.md)

## Type Aliases

- [AgentGrade](type-aliases/AgentGrade.md)
- [AgenticPattern](type-aliases/AgenticPattern.md)
- [DiagramKind](type-aliases/DiagramKind.md)
- [GradeDimension](type-aliases/GradeDimension.md)
- [GradeSeverity](type-aliases/GradeSeverity.md)
- [OperationLocus](type-aliases/OperationLocus.md)
- [ResolvedTarget](type-aliases/ResolvedTarget.md)
- [RuntimeDeployHint](type-aliases/RuntimeDeployHint.md)
- [Scope](type-aliases/Scope.md)
- [Severity](type-aliases/Severity.md)

## Variables

- [cloudflareRuntime](variables/cloudflareRuntime.md)
- [FLOOR\_LEVEL](variables/FLOOR_LEVEL.md)
- [nodeRuntime](variables/nodeRuntime.md)
- [PROFILES](variables/PROFILES.md)
- [runtimeProviders](variables/runtimeProviders.md)
- [SEED\_CATALOG](variables/SEED_CATALOG.md)

## Functions

- [affordedPatterns](functions/affordedPatterns.md)
- [agentDiagram](functions/agentDiagram.md)
- [agentDiagramHtml](functions/agentDiagramHtml.md)
- [agentGradeOk](functions/agentGradeOk.md)
- [agenticPatterns](functions/agenticPatterns.md)
- [agentLevel](functions/agentLevel.md)
- [agentManifest](functions/agentManifest.md)
- [agentMap](functions/agentMap.md)
- [analyzeScopes](functions/analyzeScopes.md)
- [assertAgentGrade](functions/assertAgentGrade.md)
- [assertAgentInstallable](functions/assertAgentInstallable.md)
- [assertDefaultServedResident](functions/assertDefaultServedResident.md)
- [assertServedSubset](functions/assertServedSubset.md)
- [assertServedSubsetGoverned](functions/assertServedSubsetGoverned.md)
- [childKeys](functions/childKeys.md)
- [conformanceOk](functions/conformanceOk.md)
- [contentHash](functions/contentHash.md)
- [contextReport](functions/contextReport.md)
- [deepStrings](functions/deepStrings.md)
- [deriveCQT](functions/deriveCQT.md)
- [deriveRequirements](functions/deriveRequirements.md)
- [effectiveUnderPolicies](functions/effectiveUnderPolicies.md)
- [findCycle](functions/findCycle.md)
- [gradeAgent](functions/gradeAgent.md)
- [gradeAgents](functions/gradeAgents.md)
- [gradeOf](functions/gradeOf.md)
- [intersectScope](functions/intersectScope.md)
- [layerReport](functions/layerReport.md)
- [lintAgents](functions/lintAgents.md)
- [lintOk](functions/lintOk.md)
- [lintPolicy](functions/lintPolicy.md)
- [lintResources](functions/lintResources.md)
- [localEscalations](functions/localEscalations.md)
- [paidToolPrice](functions/paidToolPrice.md)
- [parsePointer](functions/parsePointer.md)
- [policiesFor](functions/policiesFor.md)
- [policyAppliesTo](functions/policyAppliesTo.md)
- [policyConstrain](functions/policyConstrain.md)
- [policyOk](functions/policyOk.md)
- [projectClaudePlugin](functions/projectClaudePlugin.md)
- [projectCloudflareAgent](functions/projectCloudflareAgent.md)
- [projectNodeAgent](functions/projectNodeAgent.md)
- [projectOpenRouter](functions/projectOpenRouter.md)
- [reachableSurface](functions/reachableSurface.md)
- [renderSkillMd](functions/renderSkillMd.md)
- [residentSurface](functions/residentSurface.md)
- [residentToolNames](functions/residentToolNames.md)
- [resolveInstruction](functions/resolveInstruction.md)
- [resolveOperationRef](functions/resolveOperationRef.md)
- [resolveSkillModels](functions/resolveSkillModels.md)
- [resourceCatalog](functions/resourceCatalog.md)
- [resourceKey](functions/resourceKey.md)
- [resourceMap](functions/resourceMap.md)
- [resourcesOk](functions/resourcesOk.md)
- [routeToolDef](functions/routeToolDef.md)
- [selectModel](functions/selectModel.md)
- [skillModels](functions/skillModels.md)
- [subAgentKey](functions/subAgentKey.md)
- [subtreeDepth](functions/subtreeDepth.md)
- [suggestUnflatten](functions/suggestUnflatten.md)
- [verifyAgentFreshness](functions/verifyAgentFreshness.md)
- [verifySkillFreshness](functions/verifySkillFreshness.md)

...
[Suluk](../../packages.md) / @suluk/editor
...
[ADR C033](../../_media/C033-suluk-editor-thin-shell.md).
...
- [EditorExample](interfaces/EditorExample.md)
- [EditorOptions](interfaces/EditorOptions.md)

## Variables

- [defaultExample](variables/defaultExample.md)
- [examples](variables/examples.md)

## Functions

- [editorHtml](functions/editorHtml.md)
- [editorResponse](functions/editorResponse.md)

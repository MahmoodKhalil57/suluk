...
[Suluk](../../packages.md) / [Registry](../Registry.md) / keys

# Hierarchical API keys — pooled headroom + cascade revoke

An Effect-TS `Keys` service over [`@suluk/keys`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/keys) — the delegation
...
`provision.config.ts` and run [`@suluk/provision`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/provision).
...
flows from [`@suluk/keys`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/keys) via npm: `effectiveCaps` (a child can

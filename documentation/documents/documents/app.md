...
[Suluk](../../packages.md) / [Registry](../Registry.md) / app
...
- **npm** (`dependencies`): `hono`, `effect`, `drizzle-orm`, and
  [`@suluk/core`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/core) — the v4 foundation library (document parse /

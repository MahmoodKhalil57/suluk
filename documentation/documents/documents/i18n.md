...
[Suluk](../../packages.md) / [Registry](../Registry.md) / i18n
...
- [`@suluk/i18n`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/i18n) — the locale mechanism (see below)

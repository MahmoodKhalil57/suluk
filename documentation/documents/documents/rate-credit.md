...
[Suluk](../../packages.md) / [Registry](../Registry.md) / rate-credit
...
- [`@suluk/core`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/core) — `toProblemDetails`, the shared RFC-9457 envelope (see below)

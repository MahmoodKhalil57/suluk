...
[Suluk](../../packages.md) / [Registry](../Registry.md) / auth
...
`registryDependencies` pulls in the base [`app`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/app) module automatically (the Hono app + the Effect `Db` service).
...
[`@suluk/better-auth`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/better-auth), `@suluk/provision`, `effect`, `hono`, `drizzle-orm`.

**registry** (`registryDependencies`): [`app`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/app).

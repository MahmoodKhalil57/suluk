...
[Suluk](../../packages.md) / [Registry](../Registry.md) / reference
...
**Derived + stateless — no schema, no provision fragment** ([C052](https://github.com/MahmoodKhalil57/suluk/blob/main/doc/architecture/decisions/C052-npm-vs-registry-boundary.md)). The page is a pure function of the
...
- [`@suluk/reference`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/reference) — the complete v4-native renderer (see below)
- [`@suluk/core`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/core) — the `OpenAPIv4Document` type the `focusOn` projection walks
- `hono` — the router

**Registry (`registryDependencies`):**

- [`app`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/app) — the base Hono app the mount attaches to.
- [`contract`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/contract) — the keystone this page renders over; its `apiDocument()` is the document source.

...
[Suluk](../../../packages.md) / [Registry](../../Registry.md) / [Derivation](../Derivation.md) / contract
...
> anything on the SIG's behalf. This is an [own-the-code registry module](https://github.com/MahmoodKhalil57/suluk/blob/main/registry/derivation/README.md), wired over
...
**Stateless — no schema, no provision fragment** ([C052](https://github.com/MahmoodKhalil57/suluk/blob/main/registry/doc/architecture/decisions/C052-npm-vs-registry-boundary.md)). The contract is pure data + derivations.
...
- **registry (`registryDependencies`):** [`app`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/derivation/app) — the base Hono app the mount attaches to.

Downstream, [`reference`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/derivation/reference) and [`mcp`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/derivation/mcp) list `contract` as a `registryDependency`: both

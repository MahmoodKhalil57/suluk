...
[Suluk](../../../packages.md) / [Registry](../../Registry.md) / [Services](../Services.md) / webhooks
...
`registryDependencies` pull in the base [`app`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/services/app) module automatically (the shared Hono app + the
...
- **registry (`registryDependencies`):** [`MahmoodKhalil57/suluk/app`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/services/app) — the base Hono app + the

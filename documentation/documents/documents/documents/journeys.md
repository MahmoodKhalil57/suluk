...
[Suluk](../../../packages.md) / [Registry](../../Registry.md) / [Derivation](../Derivation.md) / journeys
...
- **npm (`dependencies`):**
  - [`@suluk/journeys`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/tooling/ts/packages/journeys) — the projection/bind/grade engine
    (`generateVocabulary`, `parseFeature`, `bindFeatures`, `coverageGrade`).
  - [`@suluk/core`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/tooling/ts/packages/core) — the `OpenAPIv4Document` type the harness parses.

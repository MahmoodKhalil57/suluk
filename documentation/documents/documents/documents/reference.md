...
[Suluk](../../../packages.md) / [Registry](../../Registry.md) / [Surfaces](../Surfaces.md) / reference
...
> anything on the SIG's behalf. This is an [own-the-code registry module](https://github.com/MahmoodKhalil57/suluk/blob/main/registry/surfaces/README.md), wired over
> the `@suluk/*` npm packages (the HYBRID pattern, [C050](https://github.com/MahmoodKhalil57/suluk/blob/main/registry/doc/architecture/decisions/C050-registry-distributed-framework.md)/[C052](https://github.com/MahmoodKhalil57/suluk/blob/main/registry/doc/architecture/decisions/C052-npm-vs-registry-boundary.md)).
...
**Derived + stateless — no schema, no provision fragment** ([C052](https://github.com/MahmoodKhalil57/suluk/blob/main/registry/doc/architecture/decisions/C052-npm-vs-registry-boundary.md)). The page is a pure function of the
...
- [`@suluk/reference`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/tooling/ts/packages/reference) — the complete v4-native renderer (see below)
- [`@suluk/core`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/tooling/ts/packages/core) — the `OpenAPIv4Document` type the `focusOn` projection walks
- `hono` — the router

**Registry (`registryDependencies`):**

- [`app`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/surfaces/app) — the base Hono app the mount attaches to.
- [`contract`](https://github.com/MahmoodKhalil57/suluk/tree/main/registry/surfaces/contract) — the keystone this page renders over; its `apiDocument()` is the document source.

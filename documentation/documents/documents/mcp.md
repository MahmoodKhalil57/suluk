...
[Suluk](../../packages.md) / [Registry](../Registry.md) / mcp
...
- [`@suluk/mcp`](https://github.com/MahmoodKhalil57/suluk/tree/main/tooling/ts/packages/mcp) — the MCP protocol + per-caller tool projection (see below)

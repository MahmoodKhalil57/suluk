...
- **[Specification](documents/Specification.md)** — the spec document, object model, signatures, conformance, and the Rust reference core.
- **[EcoSystem vision](documents/EcoSystem-vision.md)** — how one typed contract gives rise to a whole framework.

**The ecosystem** — the framework it enables:

- **[Guides](documents/Guides.md)** — the 30-second tour, the architecture, and how to contribute.
- **[Packages](packages.md)** — every `@suluk/*` package (each its own complete docs site, with its version).
- **[Registry](documents/Registry.md)** — the shadcn registry of own-the-code backend modules.
